...
export const packageDownloadsDailySchema = z.object({
...
/**
 * `PackageDownloadsDaily` contains the daily number of downloads from the registry for a package for a given period.
 *
 * @see {@link https://github.com/npm/registry/blob/master/docs/download-counts.md#ranges}
 */
export type PackageDownloadsDaily = z.infer<typeof packageDownloadsDailySchema>;
